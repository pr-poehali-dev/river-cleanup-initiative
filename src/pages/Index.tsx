...
const Index = () => {
  ...
  const facts = [
    ...
    {
      title: "Реальность",
      text: "Однако чиновники оказываются подкупленными Михаилом.",
      impact: "высокий",
    },
    {
      title: "Персонажи",
      text: "Журналист Игорь — помогает Анне раскрыть правду.",
      impact: "критический",
    },
    {
      title: "Гибель экосистем",
      text: "Эко-активистка Лена — организует протесты жителей деревни.",
      impact: "высокий",
    },
  ];
